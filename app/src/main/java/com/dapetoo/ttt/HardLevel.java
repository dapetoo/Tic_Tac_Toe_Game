    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button) findViewById(R.id.exitGame)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HardLevel.this, MainActivity.class);
        ...
        mBoardButtons[16] = findViewById(R.id.button17);
        mBoardButtons[17] = findViewById(R.id.button18);
        mBoardButtons[18] = findViewById(R.id.button19);
        mBoardButtons[19] = findViewById(R.id.button20);
        mBoardButtons[20] = findViewById(R.id.button21);
        mBoardButtons[21] = findViewById(R.id.button22);
        mBoardButtons[22] = findViewById(R.id.button23);
        mBoardButtons[23] = findViewById(R.id.button24);
        mBoardButtons[24] = findViewById(R.id.button25);
        addListenerOnButton();
